...
public class ConnectToWifiDialog extends Dialog implements View.OnClickListener 
{
    ...
    public ConnectToWifiDialog(Context context, ScanResult scanResult) 
    {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) 
    {
        ...
        wifiName = (TextView) findViewById(R.id.dialog_wifiname);
        wifiSecurity = (TextView) findViewById(R.id.dialog_security);
        pass = (EditText) findViewById(R.id.dialog_et);
        connect = (Button) findViewById(R.id.dialog_btn);
