...
public class LocalDataEntity 
{
	...
	public DeviceInfor getDeviceInfor()
	{
		...
		if(TextUtils.isEmpty(code))
			name = sharedPre.getData(DEVICE_NAME, context.getResources().getString(R.string.device_name_default) + "_" + b.MODEL);
		else
			name = sharedPre.getData(DEVICE_NAME, context.getResources().getString(R.string.device_name_default) + "_" + code);
