...
public class RatioImageView extends ImageView {
    ...
    private final int IMG_SHOW_TIME = 10 * 1000;
    ...
    private Handler mHandler = new Handler()
    {
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what == MSG_SHOW_TIME)
            {
                mHandler.sendMessageDelayed(msg,IMG_SHOW_TIME);
            }
        }
    };


    public void startImageShow()
    {
