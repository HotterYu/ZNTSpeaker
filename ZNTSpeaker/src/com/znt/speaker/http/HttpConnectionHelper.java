...
import com.znt.utils.CollectionUtil;
import com.znt.utils.MapUtil;
...
public class HttpConnectionHelper {
    ...
    private static HttpURLConnection createHttpUrlConnection(RequestParam requestParam) throws Exception {
        ...
        Log.d(TAG, "headBuffer锛宑reateHttpUrlConnection锛屽彂閫佺殑璇锋眰鍙傛暟锛�" + requestParam.toString());
        ...
        /*if (!MapUtil.isEmpty(requestParam.mHeaders)) {
            ...
            Log.i(TAG, "鑷畾涔夊ご淇℃伅澶у皬锛�" + keys.size());
            ...
            for (String key : keys) {
                ...
                Log.i(TAG, "娣诲姞鑷畾涔夊ご淇℃伅锛寀rl锛�" + url + "锛宬ey锛�" + key + "锛寁alue锛�" + value);
            }
        }
    ...
    private static Map<String, ArrayList<String>> getWritableMap(final Map<String, ? extends List<String>> 
        ...
        while (iter.hasNext()) {
            ...
            if (key != null) {
                ...
                ArrayList<String> readAndWriteList = new ArrayList<String>();// 鍙鍐欑殑map
