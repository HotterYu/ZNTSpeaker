...
public class MyDbHelper extends SQLiteOpenHelper
{
	...
	private final String DB_NAME = "znt_player.db";
	...
	protected final String TBL_SONG_LIST = "song_list_admin";//"song_list";//鐐规挱鍒楄〃
	...
	* @throws
	 */
	public synchronized long insert(ContentValues values, String tblName)
	{
		try 
		{
			checkDbStatus();
	...
	* @throws
	...
	public Cursor queryLocal()
	{
		...
		{
			String[] s = {};
			cursor = db.query(TBL_SONG_RECORD, s, "", s, "", "", order);
		} 
		catch (Exception e)
		{
			// TODO: handle exception
			close();
			db = getWritableDatabase();
			cursor = db.query(TBL_SONG_RECORD, null, null, null, null, null, order);
		}
		return cursor;
	}
